import React, { Component, useState, createElement, useEffect } from 'react';
import { View, Animated, TextInput, ScrollView, StyleSheet, Text as Text$1, Dimensions } from 'react-native';
import { Line, Text, Defs, LinearGradient, Stop, Rect, Svg, G, Path, Circle, Polygon, Polyline } from 'react-native-svg';
...
var AbstractChart = /** @class */function (_super) {
  __extends$6(AbstractChart, _super);
  function AbstractChart() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    _this.calcScaler = function (data) {
      if (_this.props.fromZero && _this.props.fromNumber) {
        return Math.max.apply(Math, __spreadArrays$1(data, [_this.props.fromNumber])) - Math.min.apply(Math, __spreadArrays$1(data, [0])) || 1;
      } else if (_this.props.fromZero) {
        return Math.max.apply(Math, __spreadArrays$1(data, [0])) - Math.min.apply(Math, __spreadArrays$1(data, [0])) || 1;
      } else if (_this.props.fromNumber) {
        return Math.max.apply(Math, __spreadArrays$1(data, [_this.props.fromNumber])) - Math.min.apply(Math, __spreadArrays$1(data, [_this.props.fromNumber])) || 1;
      } else {
    ...
    _this.renderHorizontalLines = function (config) {
      ...
      return __spreadArrays$1(new Array(count + 1)).map(function (_, i) {
    ...
    _this.renderHorizontalLabels = function (config) {
      ...
      return new Array(count === 1 ? 1 : count + 1).fill(1).map(function (_, i) {
        ...
        if (count === 1) {
          ...
          var label = _this.props.fromZero ? _this.calcScaler(data) / count * i + Math.min.apply(Math, __spreadArrays$1(data, [0])) : _this.calcScaler(data) / count * i + Math.min.apply(Math, data);
        ...
        return /*#__PURE__*/React.createElement(Text, _extends({
          ...
          textAnchor: "end",
          y: y
        }, _this.getPropsForLabels(), _this.getPropsForHorizontalLabels()), yLabel);
      });
    };
    _this.renderVerticalLabels = function (_a) {
      ...
      return labels.map(function (label, i) {
        ...
        }, _this.getPropsForLabels(), _this.getPropsForVerticalLabels()), "" + formatXLabel(label) + xAxisLabel);
      });
    };
    _this.renderVerticalLines = function (_a) {
      ...
      return __spreadArrays$1(new Array(Math.ceil(data.length / yAxisInterval))).map(function (_, i) {
        return /*#__PURE__*/React.createElement(Line, _extends({
          key: Math.random(),
...
/** @class */(function (_super) {
    ...
    _this.renderColors = function (_a) {
      ...
      return data.map(function (dataset, index) {
        ...
        return /*#__PURE__*/React.createElement(Defs, {
          key: (_a = dataset.key) !== null && _a !== void 0 ? _a : index
          ...
          return /*#__PURE__*/React.createElement(LinearGradient, {
            ...
            stopOpacity: "1"
          }), flatColor ? /*#__PURE__*/React.createElement(Stop, {
            offset: "1",
            stopColor: highOpacityColor,
            stopOpacity: "1"
          }) : /*#__PURE__*/React.createElement(Stop, {
  ...
  BarChart.prototype.render = function () {
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      height: height,
      width: width
    }, this.renderDefs(__assign$5(__assign$5({}, config), this.props.chartConfig)), this.renderColors(__assign$5(__assign$5({}, this.props.chartConfig), {
      flatColor: flatColor,
    ...
    }), /*#__PURE__*/React.createElement(G, null, withInnerLines ? this.renderHorizontalLines(__assign$5(__assign$5({}, config), {
      count: segments,
      paddingTop: paddingTop
    })) : null), /*#__PURE__*/React.createElement(G, null, withHorizontalLabels ? this.renderHorizontalLabels(__assign$5(__assign$5({}, config), {
      count: segments,
      data: data.datasets[0].data,
      paddingTop: paddingTop,
      paddingRight: paddingRight
    })) : null), /*#__PURE__*/React.createElement(G, null, withVerticalLabels ? this.renderVerticalLabels(__assign$5(__assign$5({}, config), {
      labels: data.labels,
      paddingRight: paddingRight,
      paddingTop: paddingTop,
      horizontalOffset: barWidth * this.getBarPercentage()
    })) : null), /*#__PURE__*/React.createElement(G, null, this.renderBars(__assign$5(__assign$5({}, config), {
      data: data.datasets[0].data,
      paddingTop: paddingTop,
      paddingRight: paddingRight,
      withCustomBarColorFromData: withCustomBarColorFromData
    }))), /*#__PURE__*/React.createElement(G, null, showValuesOnTopOfBars && this.renderValuesOnTopOfBars(__assign$5(__assign$5({}, config), {
      data: data.datasets[0].data,
      paddingTop: paddingTop,
      paddingRight: paddingRight
    }))), /*#__PURE__*/React.createElement(G, null, showBarTops && this.renderBarTops(__assign$5(__assign$5({}, config), {
      data: data.datasets[0].data,
      paddingTop: paddingTop,
      paddingRight: paddingRight
    })))));
...
(function (module, exports) {
	...
	var _linear = linear.exports;
	var _linear2 = _interopRequireDefault(_linear);
	var _sector = sector.exports;
...
var Pie = /*@__PURE__*/getDefaultExportFromCjs(pie.exports);
  ...
  PieChart.prototype.render = function () {
    ...
    var slices = chart.curves.map(function (c, i) {
      ...
      return /*#__PURE__*/React.createElement(G, {
        ...
        fill: c.item.color
      }), hasLegend ? /*#__PURE__*/React.createElement(Rect, {
        width: "16px",
        height: "16px",
        fill: c.item.color,
        rx: 8,
      ...
      }) : null, hasLegend ? /*#__PURE__*/React.createElement(Text, {
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      width: this.props.width,
      height: this.props.height
    }, /*#__PURE__*/React.createElement(G, null, this.renderDefs(__assign$4({
      width: this.props.height,
      height: this.props.height
    }, this.props.chartConfig))), /*#__PURE__*/React.createElement(Rect, {
      width: "100%",
      height: this.props.height,
      rx: borderRadius,
      ry: borderRadius,
...
/** @class */(function (_super) {
  __extends$3(ProgressChart, _super);
  ...
  ProgressChart.prototype.render = function () {
    ...
    var legend = !hideLegend && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(G, null, pies.map(function (_, i) {
      return /*#__PURE__*/React.createElement(Rect, {
        key: Math.random(),
        width: "16px",
        height: "16px",
    ...
    })), /*#__PURE__*/React.createElement(G, null, pies.map(function (_, i) {
      return /*#__PURE__*/React.createElement(Text, _extends({
        key: Math.random(),
        x: _this.props.width / 2.5,
        y: -(_this.props.height / 2.5) + _this.props.height * 0.8 / (Array.isArray(data) ? data.length : data.data.length) * i + 12 * 2
      }, _this.getPropsForLabels()), withLabel(i) ? data.labels[i] + " " + Math.round(100 * data.data[i]) + "%" : Math.round(100 * data.data[i]) + "%");
    })));
    return /*#__PURE__*/React.createElement(View, {
      style: __assign$3({
        width: width,
      ...
      y: this.props.height / 2
    }, /*#__PURE__*/React.createElement(G, null, pieBackgrounds.map(function (pie, i) {
    ...
    })), /*#__PURE__*/React.createElement(G, null, pies.map(function (pie, i) {
      return /*#__PURE__*/React.createElement(Path, {
        key: Math.random(),
        strokeLinecap: "round",
...
/** @class */(function (_super) {
  __extends$2(StackedBarChart, _super);
    ...
    _this.renderBars = function (_a) {
      ...
      return data.map(function (x, i) {
        ...
        for (var z = 0; z < x.length; z++) {
          ...
          ret.push( /*#__PURE__*/React.createElement(Rect, {
            key: Math.random(),
            x: xC,
            y: y,
          ...
          if (!_this.props.hideLegend) {
            ret.push( /*#__PURE__*/React.createElement(Text, _extends({
              key: Math.random(),
              x: xC + 7 + barWidth / 2,
              textAnchor: "end",
              y: h > 15 ? y + 15 : y + 7
            }, _this.getPropsForLabels()), x[z]));
          }
          st -= h;
        }
        return ret;
  ...
  StackedBarChart.prototype.render = function () {
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      height: height,
      width: width
    }, this.renderDefs(__assign$2(__assign$2({}, config), this.props.chartConfig)), /*#__PURE__*/React.createElement(Rect, {
      width: "100%",
      height: height,
      rx: borderRadius,
      ry: borderRadius,
      fill: "url(#backgroundGradient)"
    }), /*#__PURE__*/React.createElement(G, null, this.renderHorizontalLines(__assign$2(__assign$2({}, config), {
      count: segments,
      paddingTop: paddingTop,
      verticalLabelsHeightPercentage: verticalLabelsHeightPercentage
    }))), /*#__PURE__*/React.createElement(G, null, withHorizontalLabels ? this.renderHorizontalLabels(__assign$2(__assign$2({}, config), {
      count: segments,
      data: [0, border],
      paddingTop: paddingTop,
      paddingRight: paddingRight,
    ...
    })) : null), /*#__PURE__*/React.createElement(G, null, withVerticalLabels ? this.renderVerticalLabels(__assign$2(__assign$2({}, config), {
      labels: data.labels,
      ...
      verticalLabelsHeightPercentage: verticalLabelsHeightPercentage
    })) : null), /*#__PURE__*/React.createElement(G, null, this.renderBars(__assign$2(__assign$2({}, config), {
      data: data.data,
      border: border,
      ...
      stackedBar: stackedBar,
      verticalLabelsHeightPercentage: verticalLabelsHeightPercentage
    }))), showLegend && this.renderLegend(__assign$2(__assign$2({}, config), {
      legend: data.legend,
      colors: this.props.data.barColors
    }))));
  };
...
var paddingLeft = 32;
/** @class */(function (_super) {
  __extends$1(ContributionGraph, _super);
  ...
  ContributionGraph.prototype.getClassNameForIndex = function (index) {
    if (this.state.valueCache[index]) {
      if (this.state.valueCache[index].value) {
        ...
        if (count) {
          var opacity = mapValue(count, this.state.maxValue === this.state.minValue ? 0 : this.state.minValue, isNaN(this.state.maxValue) ? 1 : this.state.maxValue, 0.15 + 0.05,
          // + 0.05 to make smaller values a bit more visible
          1);
  ...
  ContributionGraph.prototype.renderMonthLabels = function () {
    ...
    return weekRange.map(function (weekIndex) {
      ...
      var _a = _this.getMonthLabelCoordinates(weekIndex),
        x = _a[0],
        y = _a[1];
      return endOfWeek.getDate() >= 1 && endOfWeek.getDate() <= DAYS_IN_WEEK ? /*#__PURE__*/React.createElement(Text, _extends({
        key: weekIndex,
        x: x + paddingLeft,
        y: y + 8
      }, _this.getPropsForLabels()), _this.props.getMonthLabel ? _this.props.getMonthLabel(endOfWeek.getMonth()) : MONTH_LABELS[endOfWeek.getMonth()]) : null;
    });
  };
  ContributionGraph.prototype.render = function () {
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      ry: borderRadius,
      fill: "url(#backgroundGradient)"
    }), /*#__PURE__*/React.createElement(G, null, this.renderMonthLabels()), /*#__PURE__*/React.createElement(G, null, this.renderAllWeeks())));
  };
...
var LegendItem = function (props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Rect, {
    ...
    y: centerAlignedText
  }, props.labelProps), props.legendText));
};
...
var LineChart = /** @class */function (_super) {
  ...
  function LineChart() {
    ...
    _this.renderDots = function (_a) {
      ...
      data.forEach(function (dataset) {
        ...
        dataset.data.forEach(function (x, i) {
          ...
          output.push( /*#__PURE__*/React.createElement(Circle, _extends({
            key: Math.random(),
            cx: cx,
            cy: cy,
            fill: typeof getDotColor === "function" ? getDotColor(x, i) : _this.getColor(dataset, 0.9),
            onPress: onPress
          }, _this.getPropsForDots(x, i))), /*#__PURE__*/React.createElement(Circle, {
            key: Math.random(),
            cx: cx,
            cy: cy,
            r: "14",
    ...
    _this.renderScrollableDot = function (_a) {
      ...
      data.forEach(function (dataset) {
        ...
        output.push([/*#__PURE__*/React.createElement(Animated.View, {
          key: Math.random(),
    ...
    _this.renderLine = function (_a) {
      ...
      data.forEach(function (dataset, index) {
        ...
        output.push( /*#__PURE__*/React.createElement(Polyline, {
          key: index,
  ...
  LineChart.prototype.render = function () {
    ...
    return /*#__PURE__*/React.createElement(View, {
    ...
    }), this.props.data.legend && this.renderLegend(config.width, legendOffset), /*#__PURE__*/React.createElement(G, {
      x: "0",
      y: legendOffset
    }, this.renderDefs(__assign(__assign(__assign({}, config), chartConfig), {
      data: data.datasets
    })), /*#__PURE__*/React.createElement(G, null, withHorizontalLines && (withInnerLines ? this.renderHorizontalLines(__assign(__assign({}, config), {
      count: count,
      paddingTop: paddingTop,
      paddingRight: paddingRight
      ...
      paddingTop: paddingTop,
      paddingRight: paddingRight
    })) : null)), /*#__PURE__*/React.createElement(G, null, withHorizontalLabels && this.renderHorizontalLabels(__assign(__assign({}, config), {
      count: count,
      data: datas,
      paddingTop: paddingTop,
      paddingRight: paddingRight,
    ...
    }))), /*#__PURE__*/React.createElement(G, null, withVerticalLines && (withInnerLines ? this.renderVerticalLines(__assign(__assign({}, config), {
      data: data.datasets[0].data,
      paddingTop: paddingTop,
      paddingRight: paddingRight
      ...
      paddingTop: paddingTop,
      paddingRight: paddingRight
    })) : null)), /*#__PURE__*/React.createElement(G, null, withVerticalLabels && this.renderVerticalLabels(__assign(__assign({}, config), {
      labels: labels,
      paddingTop: paddingTop,
      paddingRight: paddingRight,
      formatXLabel: formatXLabel
    }))), /*#__PURE__*/React.createElement(G, null, this.renderLine(__assign(__assign(__assign({}, config), chartConfig), {
      paddingRight: paddingRight,
      paddingTop: paddingTop,
      data: data.datasets
    }))), /*#__PURE__*/React.createElement(G, null, withShadow && this.renderShadow(__assign(__assign({}, config), {
      data: data.datasets,
      paddingRight: paddingRight,
      paddingTop: paddingTop,
      useColorFromDataset: chartConfig.useShadowColorFromDataset
    }))), /*#__PURE__*/React.createElement(G, null, withDots && this.renderDots(__assign(__assign({}, config), {
      data: data.datasets,
      paddingTop: paddingTop,
      paddingRight: paddingRight,
      onDataPointClick: onDataPointClick
    }))), /*#__PURE__*/React.createElement(G, null, withScrollableDot && this.renderScrollableDot(__assign(__assign(__assign({}, config), chartConfig), {
      data: data.datasets,
      paddingTop: paddingTop,
      paddingRight: paddingRight,
      onDataPointClick: onDataPointClick,
      scrollableDotHorizontalOffset: scrollableDotHorizontalOffset
    }))), /*#__PURE__*/React.createElement(G, null, decorator && decorator(__assign(__assign({}, config), {
      data: data.datasets,
      paddingTop: paddingTop,
      paddingRight: paddingRight
    }))))), withScrollableDot && /*#__PURE__*/React.createElement(ScrollView, {
 ...
 */
const validateHexColor = (value, defaultValue) => hexColorValidate.test(value) ? value : defaultValue;
 ...
 */
const validateNumericsValue = (value, min, max) => value < min ? min : value > max ? max : value;
 ...
 */
function toThousandsDivider(num) {
 ...
 * @returns   {string}    formatted number as a string
 */
function toInternationalSystemFormatting(num) {
  // Nine Zeroes for Billions
  return Math.abs(Number(num)) >= 1.0e9 ? (Math.abs(Number(num)) / 1.0e9).toFixed(2) + "B" :
  // Six Zeroes for Millions
  Math.abs(Number(num)) >= 1.0e6 ? (Math.abs(Number(num)) / 1.0e6).toFixed(2) + "M" :
  // Three Zeroes for Thousands
  Math.abs(Number(num)) >= 1.0e3 ? (Math.abs(Number(num)) / 1.0e3).toFixed(2) + "K" : Math.abs(Number(num));
}
...
function LineChartComponent({
   ...
   */
  const dotContent = (x, y, indexData) => createElement(View, {
    style: {
      position: "absolute",
    ...
    style: {
      color: validateHexColor(dotContentColor, defaultColor)
    }
  }, indexData));
   ...
   */
  const decoratorContent = createElement(View, {
    style: {
      position: "absolute",
  ...
  useEffect(() => {
    ...
    if (labelsDataSource?.status === "available" && isReady) {
      ...
      let data = {
        ...
        ...(withLegends && {
          legend: dataSeries.map(dataset => dataset.legend?.value)
        })
      };
      let config = {
        // =======> Chart Background
  ...
  if (isEmpty || !chartConfig) {
    return createElement(View, null, createElement(Text$1, null, "Empty Chart"));
  } else {
    return createElement(LineChart, {
      data: dataSource,
      chartConfig: chartConfig,
      width: chartWidth === "full" ? Dimensions.get("window").width : validateNumericsValue(customWidth, 0, Dimensions.get("window").width),
      ...
      onDataPointClick: ({
        ...
        x,
        y
      }) => onDataPointClick(index, dataset, x, y),
...
function NativeLineChart(props) {
  return createElement(LineChartComponent, props);
}

export { NativeLineChart };
